...
def parse_args():
    ...
    parser.add_argument('--seq_len', default=200, type=int) #64
    parser.add_argument('--batch_size', default=100, type=int) 
    parser.add_argument('--MIL_k', default=2, type=int) #### 2
    parser.add_argument('--corr_thres', default=0.85, type=float) 
    parser.add_argument('--context_length', default=77, type=float) 
    parser.add_argument('--anatomy_aware', default=False, type=bool) 
    parser.add_argument('--with_alignability', default=False, type=bool) 
    parser.add_argument('--is_knowledge', default=False, type=bool) 
    parser.add_argument('--VideoQA', default=False, type=bool) 
    parser.add_argument('--ImageQA', default=True, type=bool) 
    parser.add_argument('--is_blank', default=True, type=bool) 
    parser.add_argument('--loss_correction', default=True, type=bool) #### True
    # parser.add_argument('--cross_img', default=True, type=bool) 
    parser.add_argument('--loss', default='nce', type=str)
    # parser.add_argument('--gt_type', default='sort', type=str) # sort, viterbi, split
    parser.add_argument('--lr', default=2e-6, type=float) #5e-5
    parser.add_argument('--wd', default=2e-7, type=float) #5e-6
    ...
    # parser.add_argument('--resume', default='./ours.pth.tar', type=str)
    # parser.add_argument('--resume', default='/media/engs2527/2TBSlow1/log-tmp_step2/2024_01_08_21_26_htm-pulseInter6-trans_len200_pos-learned_bs100_IQATrue_VQAFalse_MILk2_lr2e-06/model/model_best_epoch49.pth.tar', type=str)
    ...
    parser.add_argument('--prefix', default='tmp_step2', type=str)
...
def set_path(args):
    ...
    if args.resume: 
        ...
        exp_path = (f"log-{args.prefix}/{name_prefix}{dt_string}_"
            ...
            f"bs{args.batch_size}_IQA{args.ImageQA}_VQA{args.VideoQA}_MILk{args.MIL_k}_lr{args.lr}{tag_agreement}")
