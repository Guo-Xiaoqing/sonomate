...
label_set_complex = []
import json
json_path = '/2TBFast/sonomate/vqa_dataset/anatomy_graph.json'
...
feature_path = '/2TBFast/sonomate/vqa_dataset/val_2nd_class/Second_Trimester_Classfication_Dataset/'
# label_path = '/2TBFast/sonomate/vqa_dataset/val_2nd_class/Second_Trimester_Classfication_Dataset.txt'
label_path = '/2TBFast/sonomate/vqa_dataset/val_2nd_class/Second_Trimester_Classfication_Dataset_new.txt'
